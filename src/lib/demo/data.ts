/**
 * Demo report data - shared between /api/demo and /api/pdf routes
 */

import { BrandReport } from '@/lib/extractors/types'

export const DEMO_ID = 'demo-nike-report'
export const DEMO_SLUG = 'demo-nike-brand'

export const DEMO_REPORT: BrandReport = {
  id: DEMO_ID,
  domain: 'nike.com',
  brandName: 'Nike',
  ...
  consistency: {
    ...
    grade: 'A',
    breakdown: {
      color: { score: 24, max: 25, status: 'scored' },
      typography: { score: 20, max: 20, status: 'scored' },
      tone: { score: 24, max: 25, status: 'scored' },
      seo: { score: 14, max: 15, status: 'scored' },
      message: { score: 13, max: 15, status: 'scored' },
    },
    insufficientData: [],
    pagesAnalyzed: 25,
    issues: [
